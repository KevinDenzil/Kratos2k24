...
import { GiCardRandom, GiGoalKeeper, GiSoccerBall, GiRobber  } from "react-icons/gi";
...
const eventData = {
    "Technical Events": {
        ...
        "Logic break": { 
            ...
            prizes: ["", ""]  },
        "Technical Fued": { "desc": "", "team_size": 2, "price": "", icon: <BsFillLightningChargeFill />, rules: [], prizes: ["", ""]  },
        "UI UX Design Battle": { 
        ...
        "Code Relay": { 
            ...
            prizes: ["500", "300"]  },
        "Capture the Flag": { "desc": "", "team_size": 2, "price": "", icon: <FaFlag />, rules: [], prizes: ["", ""] },
        "Bid to Predict": { "desc": "", "team_size": 2, "price": "", icon: <FaChartLine />, rules: [], prizes: ["", ""]},
        "The Code Gambit": { "desc": "", "team_size": 2, "price": "",icon : <GiCardRandom />, rules: [], prizes: ["", ""]},
        "Cyber Heist": { 
    ...
    "Non-Technical Events": {
        "Channel Surfing": { 
            ...
            prizes: ["", ""] },
        "Title Event": { "desc": "", "team_size": 2, "price": "", icon: <FaCrown />, rules: [], prizes: ["", ""] },
        "Cine Quiz": { "desc": "", "team_size": 2, "price": "", icon:<BsCameraReelsFill />, rules: [], prizes: ["", ""] },
        "Fem Screen": { "desc": "", "team_size": 2, "price": "", icon : <PiMicrophoneStageFill />, rules: [], prizes: ["", ""] },
        "Green Screen": { 
    ...
    "Pre Events": {
        "Photography": { "desc": "", "team_size": 1, "price": "", icon : <FaCamera />, rules: [], prizes: ["", ""] },
        "Reel Song": { "desc": "", "team_size": 2, "price": "", icon:<FaMusic />, rules: [], prizes: ["", ""] },
        "Reel Dance": { "desc": "", "team_size": 2, "price": "", icon : <FaRedhat />, rules: [], prizes: ["", ""] },
        "Valorant": { 
